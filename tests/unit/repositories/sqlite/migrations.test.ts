...
describe('SQLite migration system', () => {
  ...
  describe('real migrations', () => {
    it('applies 001_initial_schema.sql successfully', () => {
      ...
      expect(names).toContain('serials')
      ...
      expect(names).toContain('bom_contributing_jobs')
    ...
    it('creates all expected indexes', () => {
      ...
      expect(indexNames).toContain('idx_serials_job_id')
      expect(indexNames).toContain('idx_serials_path_id')
      expect(indexNames).toContain('idx_serials_step_index')
      expect(indexNames).toContain('idx_cert_attachments_serial')
      expect(indexNames).toContain('idx_cert_attachments_cert')
      expect(indexNames).toContain('idx_audit_serial')
