...
describe('AuditService', () => {
  ...
  it('recordCertAttachment creates entry with correct action and fields', () => {
    ...
    expect(entry.partId).toBe('part_1')
  ...
  it('recordPartCreation creates entry with batch quantity', () => {
    const entry = service.recordPartCreation({
      userId: 'user_1',
      jobId: 'job_1',
      pathId: 'path_1',
      batchQuantity: 10
  ...
  it('recordPartAdvancement creates entry with from/to steps', () => {
  ...
  it('recordPartCompletion creates entry with correct action', () => {
  ...
  it('getJobAuditTrail delegates to repo', () => {
    service.recordPartCreation({ userId: 'u', jobId: 'job_1', pathId: 'p', batchQuantity: 5 })
  ...
  it('listAuditEntries supports pagination', () => {
    for (let i = 0; i < 5; i++) {
      service.recordPartCreation({ userId: 'u', jobId: 'j', pathId: 'p', batchQuantity: 1 })
    }
