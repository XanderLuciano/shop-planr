...
- [ ] 1. Database migration
  - [ ] 1.1 Create migration `server/repositories/sqlite/migrations/007_step_id_tracking.sql`
...
- [ ] 2. Domain types and interfaces
  - [ ] 2.1 Update `server/types/domain.ts`
  ...
  - [ ] 2.2 Update `server/types/api.ts`
  ...
  - [ ] 2.3 Update `server/types/computed.ts`
  ...
  - [ ] 2.4 Update `app/types/` re-exports
...
- [ ] 3. Repository layer changes
  - [ ] 3.1 Update `server/repositories/interfaces/partRepository.ts`
  ...
  - [ ] 3.2 Update `server/repositories/sqlite/partRepository.ts`
  ...
  - [ ] 3.3 Update `server/repositories/interfaces/partStepStatusRepository.ts`
  ...
  - [ ] 3.4 Update `server/repositories/sqlite/partStepStatusRepository.ts`
  ...
  - [ ] 3.5 Update `server/repositories/sqlite/pathRepository.ts`
  ...
  - [ ]* 3.6 Write property test for Part repository round-trip with currentStepId
  ...
  - [ ]* 3.7 Write property test for query by currentStepId
...
- [ ] 4. Checkpoint — Ensure migration and repository layer compile
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 5. Service layer changes
  - [ ] 5.1 Update `server/services/partService.ts`
  ...
  - [ ] 5.2 Update `server/services/lifecycleService.ts`
  ...
  - [ ] 5.3 Update `server/services/pathService.ts`
  ...
  - [ ]* 5.4 Write property tests for advancement
  ...
  - [ ]* 5.7 Write property test for bypassed/recycled steps
  ...
  - [ ]* 5.8 Write property test for latest sequence query
  ...
  - [ ]* 5.9 Write property test for reconcileSteps by ID
  ...
  - [ ]* 5.10 Write property test for step delete guard
  ...
  - [ ]* 5.11 Write property test for step distribution
  ...
  - [ ]* 5.12 Write property test for completed count
...
- [ ] 7. API route changes
  - [ ] 7.1 Update `server/api/operator/step/[stepId].get.ts`
  ...
  - [ ] 7.2 Update `server/api/operator/work-queue.get.ts`
    - Replace `partService.listPartsByStepIndex(path.id, step.order)` with `partService.listPartsByCurrentStepId(step.id)`
    - _Requirements: 9.1_

  - [ ] 7.3 Update `server/api/parts/[partId]/advance-to.post.ts` (or equivalent)
    - Accept `targetStepId` instead of `targetStepIndex` in request body
    - Pass `targetStepId` to `lifecycleService.advanceToStep`
    - _Requirements: 2.3_

  - [ ] 7.4 Create Full Route API endpoint `server/api/parts/[partId]/full-route.get.ts`
  ...
  - [ ]* 7.5 Write property test for full route sections
  ...
  - [ ]* 7.6 Write property test for N/A steps
  ...
  - [ ]* 7.7 Write property test for soft-delete
...
- [ ] 8. Checkpoint — Ensure API layer tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 9. Update existing tests referencing currentStepIndex
  - [ ] 9.1 Update property tests
...
- [ ] 10. Checkpoint — Ensure all existing tests pass with updated references
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 11. Frontend changes
  - [ ] 11.1 Update `app/composables/useLifecycle.ts`
    - `advanceToStep`: send `targetStepId` instead of `targetStepIndex` in request body
    - _Requirements: 2.3_

  - [ ] 11.2 Create `app/composables/useFullRoute.ts`
    - New composable that fetches `GET /api/parts/:partId/full-route`
    - Returns reactive `entries`, `isCompleted`, `loading`, `error` refs
    - _Requirements: 11.1, 12.1_

  - [ ] 11.3 Update `app/pages/parts-browser/[id].vue` — Part detail routing card
...
- [ ] 12. Checkpoint — Ensure frontend compiles and all tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 13. Update AI agent documentation
  - [ ] 13.1 Update `.ai/architecture.md`
  ...
  - [ ] 13.3 Verify `.kiro/steering/separation-of-concerns.md` is up to date
