...
<template>
  <div class="flex flex-wrap justify-start gap-x-1 gap-y-2 items-stretch py-1">
    <template v-for="(step, i) in distribution" :key="step.stepId">
      <!-- Arrow between steps -->
    ...
    <!-- Completed column -->
    <div
      class="flex flex-col items-center justify-center min-w-[90px] sm:min-w-[110px] max-w-[150px] flex-1 px-1.5 py-1 rounded border border-green-300 dark:border-green-700 bg-green-50 dark:bg-green-950/30 text-center"
    >
